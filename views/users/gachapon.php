    ...
    <div class="main">
        ...
        <div class="contenedor-gachapon">
            <video autoplay loop muted>
                <source src="/videos/gachapon.mp4" type="video/mp4">
            </video>
        </div>
        <div class="gachapon-info">
            <h2>Título del Gachapon</h2>
            <p>Descripción del Gachapon. Aquí puedes tirar para obtener premios aleatorios.</p>
        </div>
        <div class="boton-tirar">
